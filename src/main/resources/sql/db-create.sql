...
ALTER TABLE PhotovoltaicMeasurement ADD COLUMN IF NOT EXISTS areaServed polygon;
...
ALTER TABLE PhotovoltaicMeasurement ADD COLUMN IF NOT EXISTS entityId text;
