...
import org.computate.smartvillage.enus.model.photovoltaicmeasurement.PhotovoltaicMeasurementPage;
			...
			for(String entityVar : methodNames) {
				switch(entityVar) {
					...
					case "setEntityId":
							...
							if(bParams.size() > 0)
								bSql.append(", ");
							bSql.append(PhotovoltaicMeasurement.VAR_entityId + "=$" + num);
							num++;
			...
			if(jsonObject != null) {
				...
				for(String entityVar : entityVars) {
					...
					case PhotovoltaicMeasurement.VAR_temperature:
						...
						bParams.add(o2.sqlTemperature());
						break;
					case PhotovoltaicMeasurement.VAR_entityId:
						o2.setEntityId(jsonObject.getString(entityVar));
						if(bParams.size() > 0) {
							bSql.append(", ");
						}
