 ...
 * Role.enUS: SiteAdmin
 *
 * AName.enUS: a PhotovoltaicMeasurement
...
public class PhotovoltaicMeasurement extends PhotovoltaicMeasurementGen<BaseModel> {
        ...
        protected void _objectTitle(Wrap<String> w) {
                ...
                b.append(Optional.ofNullable(entityShortId).map(s -> String.format("%s - %s", PhotovoltaicMeasurement_NameAdjectiveSingular_enUS, s)).orElse(pk.toString()));
                w.o(b.toString().trim());
        }
