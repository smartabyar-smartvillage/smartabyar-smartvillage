 ...
 * Generated: true
 **/
public class CrowdFlowObservedGenPage extends CrowdFlowObservedGenPageGen<BaseModelPage> {
	...
	protected void _varsFq(JsonObject vars) {
		...
		CrowdFlowObserved.varsFqForClass().forEach(var -> {
	...
	protected void _crowdFlowObservedCount(Wrap<Integer> w) {
		w.o(searchListCrowdFlowObserved_ == null ? 0 : searchListCrowdFlowObserved_.size());
	}

	protected void _crowdFlowObserved_(Wrap<CrowdFlowObserved> w) {
		if(crowdFlowObservedCount == 1 && Optional.ofNullable(siteRequest_.getServiceRequest().getParams().getJsonObject("path")).map(o -> o.getString("id")).orElse(null) != null)
	...
	protected void _pageTitle(Wrap<String> c) {
		if(crowdFlowObserved_ != null && crowdFlowObserved_.getObjectTitle() != null)
			c.o(crowdFlowObserved_.getObjectTitle());
		else if(crowdFlowObserved_ != null)
			c.o("CrowdFlowObserveds");
		else if(searchListCrowdFlowObserved_ == null || crowdFlowObservedCount == 0)
	...
	protected void _roleForWrite(List<String> l) {
		Optional.ofNullable(siteRequest_.getConfig().getString(ConfigKeys.AUTH_ROLE_REQUIRED + "_CrowdFlowObserved")).ifPresent(v -> {
			l.add(v);
		});
	}
	...
	protected void _pageDescription(Wrap<String> c) {
			c.o("ApiTag.enUS: CrowdFlowObserved");
	}
